...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  (document.getElementById("relayUrl") as HTMLInputElement).value = cfg.relayUrl || "";
  (document.getElementById("wsSecret") as HTMLInputElement).value = cfg.wsSecret || "";

  document.getElementById("save")!.addEventListener("click", async () => {
    const relayUrl = (document.getElementById("relayUrl") as HTMLInputElement).value.trim();
    const wsSecret = (document.getElementById("wsSecret") as HTMLInputElement).value.trim();
